...
<p><a href="javascript: countries.expandit(3)">Dynamically select last Tab</a> | <a href="/admin/main?countrytabs=1">Reload page and select 2nd tab using URL parameter</a></p>
