...
$objDrawing->setPath($_SERVER["DOCUMENT_ROOT"].'/application/views/test/images/officelogo.jpg');
...
$objDrawing->setPath($_SERVER["DOCUMENT_ROOT"].'/application/views/test/images/paid.png');
...
$objDrawing->setPath($_SERVER["DOCUMENT_ROOT"].'/application/views/test/images/phpexcel_logo.gif');
$objDrawing->setHeight(36);
...
$objDrawing->setPath($_SERVER["DOCUMENT_ROOT"].'/application/views/test/images/termsconditions.jpg');
