...
if (!file_exists($_SERVER["DOCUMENT_ROOT"]."/application/views/test/14excel5.xls")) {
...
$objPHPExcel = PHPExcel_IOFactory::load($_SERVER["DOCUMENT_ROOT"]."/application/views/test/14excel5.xls");
