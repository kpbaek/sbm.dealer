...
<head>
	...
	<script src="/js/jqgrid_demo40/js/jquery.min.js" type="text/javascript"></script>
	<script src="/js/jqgrid_demo40/js/i18n/grid.locale-en.js" type="text/javascript"></script>
	<script src="/js/jqgrid_demo40/js/jquery.jqGrid.min.js" type="text/javascript"></script>	
	<script src="/js/jqgrid_demo40/js/jquery-ui-1.8.2.custom.min.js" type="text/javascript"></script>
</head>
<body>
